...
st.set_page_config(page_title='Phuc Le' ,layout="wide",page_icon='👧🏻')
...
html_lottie = load_lottieurl("https://lottie.host/b0f3c0eb-112b-4c7e-8079-760b0a839efb/kyZQX2sVPA.json")
java_lottie = load_lottieurl("https://assets9.lottiefiles.com/packages/lf20_zh6xtlj9.json")
css_lottie = load_lottieurl("https://lottie.host/17cecb9a-2893-4077-896c-6e30f0f04036/SuZlFlSSdA.json")
...
with st.container():
    ...
    with col2:
        st_lottie(html_lottie, height=70, width=70, key="html", speed=4)
    with col3:
    ...
    with col2:
        st_lottie(css_lottie, height=70, width=70, key="docker", speed=2.5)
    with col3:
...
with st.container():
    ...
    with col1:
        ...
        st.info("Data Science 365: https://learn.365datascience.com/profile/phuc-le/")
